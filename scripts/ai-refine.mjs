...
const generationPrompt = [
  ...
  "Use the generated next/font variables; visibly differentiate display and body typography. All normal text, including button and control labels, must meet WCAG AA 4.5:1 contrast; large text may use 3:1. The 3:1 non-text UI-component threshold never exempts text inside a control. Controls must retain visible focus, and motion must have a prefers-reduced-motion path.",
  "Keep every display clamp at or below 8rem and display line-height at or above 0.82. The bilingual onboarding headline is capped at 120 characters; prefer an 18–28ch measure and compose it dramatically without making the h1 taller than the initial desktop viewport.",
